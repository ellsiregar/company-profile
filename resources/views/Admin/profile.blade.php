        ...
        <div class="bg-light rounded h-100 p-4">
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="user_name" name="username" value="{{ old('username', $profile->username) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="alamat" name="password">
                    <div class="text-danger">
                        @error('password')
                        {{ $message }}
                        @enderror
