                ...
                <div class="card-body">
                    <form action="{{ route('admin.contact.update', $contact->id_contact) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_tlpn" name="no_tlpn" value="{{ old('no_tlpn', $contact->no_tlpn) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ old('lokasi', $contact->lokasi) }}" placeholder="Masukkan alamat atau URL lokasi" required>
                            <div class="text-danger">
                                @error('lokasi')
                                    {{ $message }}
                                @enderror
