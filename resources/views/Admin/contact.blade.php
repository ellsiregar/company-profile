    ...
    <div class="bg-light rounded h-100 p-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{route('admin.contact_tambah')}}" class="btn btn-primary btn-sm">Tambah</a>
                    ...
                    @foreach($events as $event)
                        ...
                        <td>
                            ...
                            <a href="{{route( )}}" onclick="return confirm('Yakin Ingin Menghapus Data Tersebut')" class="btn btn-danger btn-sm">delete</a>
                        </td>
